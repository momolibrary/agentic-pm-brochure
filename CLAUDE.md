...
| 修改 Agent | `CLAUDE.md` → `multica/CLAUDE.md` → `multica/agents/CLAUDE.md` → 具体 Agent 文件 |
...
| 新增 Agent/Skill | multica 体系 | `multica/CLAUDE.md` + 对应子目录 CLAUDE.md |
| 修改术语 | 全项目 | `standards/CLAUDE.md`（记录变更） |
| 新增章节 | manuscript | `manuscript/CLAUDE.md`（更新目录） |
| 修改工作流 | multica 体系 | `multica/workflows/CLAUDE.md` + 受影响 Agent |
